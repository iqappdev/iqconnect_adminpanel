          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="form-group">
                <input class="form-control" name="email" id="email" placeholder="To:" readonly value="<?php echo $row1['email']; ?>">
              </div>
              <div class="form-group">
                <input class="form-control" name="subject" id="subject" placeholder="Subject:" readonly value="Reply:<?php echo $row1['subject']; ?>">
              </div>
              <div class="form-group">
                    <textarea id="mail_content" name="mail_content" class="form-control" style="height: 300px">
                      ...
                      On <?php echo $row1['mail_time']; ?> (<?php echo $row1['name']; ?>) <<?php echo $row1['email']; ?>> wrote :
